...
Gem::Specification.new do |s|
  ...
  s.version     = '1.4.2'
  s.date        = '2019-01-23'
  s.summary     = 'National Holidays for 80 countries'
  s.description = 'Uses config from the national-holidays-config project to provide access to national holiday data across 80 countries'
